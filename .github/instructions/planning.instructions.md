---
applyTo: '.github/planning/**, **/*.plan.md'
...
- Format: `[NNN].plan.md` (e.g., `042.plan.md`)
...
```frontmatter
---
title: `[NNN]–[Descriptive Feature Name]`
status: `status: draft || in-progress: stage-XX/task-YY/step-ZZ || completed`
---
```

#### 1. Title

- format: `[NNN]–[Descriptive Feature Name]`
- example: `042-UserAuth`

#### 2. Status

Below the title:

- format: `status: draft || in-progress: stage-XX/task-YY/step-ZZ || completed`
- example: `
...
- Filename: `[nnn].plan.md` where `nnn` is the issue number.
